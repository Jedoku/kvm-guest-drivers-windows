...
DWORD CDevice::Run()
{
    ...
    HANDLE hDevice = CreateFile(
            DevicePath, GENERIC_WRITE, 0, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL | FILE_FLAG_OVERLAPPED, NULL);
...
PTCHAR CDevice::GetDevicePath(IN LPGUID InterfaceGuid)
{
    ...
    do
    {
        cr = CM_Get_Device_Interface_List_Size(
                &DeviceInterfaceListLength, InterfaceGuid, NULL, CM_GET_DEVICE_INTERFACE_LIST_PRESENT);
